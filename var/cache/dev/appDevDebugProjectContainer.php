...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'medical_analysis.antispam' => 'getMedicalAnalysis_AntispamService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MainBundle', ($this->targetDirs[3].'/app/Resources/MainBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MainBundle', ($this->targetDirs[3].'/src/MyApp/MainBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MedicalAnalysisBundle', ($this->targetDirs[3].'/app/Resources/MedicalAnalysisBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MedicalAnalysisBundle', ($this->targetDirs[3].'/src/Medical/AnalysisBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('VTrlv-Jljr', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OsZRAejXwx', 0, 'gPtTtVAl49vtXjpuA3WVUo', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Medical/AnalysisBundle/Entity'))), 'Medical\\AnalysisBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('MedicalAnalysisBundle' => 'Medical\\AnalysisBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_93ef318cc752c12a60dcfaaaa4f60fd6cc73d5c3072b4195afae698d2b44697d');
    ...
    /**
     * Gets the 'medical_analysis.antispam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Medical\AnalysisBundle\AntiSpam\OCAntispam A Medical\AnalysisBundle\AntiSpam\OCAntispam instance
     */
    protected function getMedicalAnalysis_AntispamService()
    {
        return $this->services['medical_analysis.antispam'] = new \Medical\AnalysisBundle\AntiSpam\OCAntispam($this->get('swiftmailer.mailer.default'), 'en', 60);
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension(${($_ = isset($this->services['assetic.asset_factory']) ? $this->services['assetic.asset_factory'] : $this->getAssetic_AssetFactoryService()) && false ?: '_'}, $this->get('templating.name_parser'), false, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'SensioFrameworkExtraBundle', 7 => 'AsseticBundle', 8 => 'AppBundle', 9 => 'MainBundle', 10 => 'MedicalAnalysisBundle', 11 => 'DoctrineFixturesBundle', 12 => 'DebugBundle', 13 => 'WebProfilerBundle', 14 => 'SensioDistributionBundle', 15 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/MyApp/MainBundle/Resources/views'), 'Main');
        $instance->addPath(($this->targetDirs[3].'/src/Medical/AnalysisBundle/Resources/views'), 'MedicalAnalysis');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('758f9045e8c39313af2349025d32260d1aee4da1');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uF3kkNnTtC', 0, 'gPtTtVAl49vtXjpuA3WVUo', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('592ee4d249c352.53159772')), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'MainBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/MyApp/MainBundle'),
                    'namespace' => 'MyApp\\MainBundle',
                ),
                'MedicalAnalysisBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Medical/AnalysisBundle'),
                    'namespace' => 'Medical\\AnalysisBundle',
                ),
            ...
            case 'upload_dir': $value = ($this->targetDirs[3].'/app/../web/uploads'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MainBundle' => 'MyApp\\MainBundle\\MainBundle',
                'MedicalAnalysisBundle' => 'Medical\\AnalysisBundle\\MedicalAnalysisBundle',
            ...
            'secret' => '758f9045e8c39313af2349025d32260d1aee4da1',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '758f9045e8c39313af2349025d32260d1aee4da1',
            ...
            'assetic.bundles' => array(
                ...
                8 => 'AppBundle',
                9 => 'MainBundle',
                10 => 'MedicalAnalysisBundle',
                11 => 'DoctrineFixturesBundle',
                12 => 'DebugBundle',
